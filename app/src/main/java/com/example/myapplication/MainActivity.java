...
public class MainActivity extends AppCompatActivity {
    ...
    public void crearCliente(View view){
        ...
        boolean terminosceptados=ckterminos.isChecked();
        boolean pomocionesAceptadas=ckpromociones.isChecked();
        String rol=spRol.getSelectedItem().toString();
        System.out.println("roooooooool"+rol);
        if (name.isEmpty() || ageStr.isEmpty() || rdseleccionado==null || !terminosceptados || !pomocionesAceptadas){
            ...
            Cliente c=new Cliente(name,edad,genero,terminosceptados,pomocionesAceptadas);
            Toast.makeText(this, "Cliente nuevo"+ c.getNombre(), Toast.LENGTH_SHORT).show();
